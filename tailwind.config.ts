    ...
    extend: {
      ...
      colors: {
        ...
        lavcom: {
          ...
          "orange-dark": "hsl(var(--lavcom-orange-dark))",
          "gray-dark": "hsl(var(--lavcom-gray-dark))",
          "gray-light": "hsl(var(--lavcom-gray-light))",
        },
        chart: {
          cb: "hsl(var(--chart-cb))",
          esp: "hsl(var(--chart-esp))",
          fidelite: "hsl(var(--chart-fidelite))",
          lave: "hsl(var(--chart-lave))",
          seche: "hsl(var(--chart-seche))",
          lessive: "hsl(var(--chart-lessive))",
          recharge: "hsl(var(--chart-recharge))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
