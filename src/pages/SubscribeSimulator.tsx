...
export default function SubscribeSimulator() {
  ...
  const simulatorFeatures = t('app:subscribeSimulator.plans.simulator.features', { returnObjects: true }) as string[];
  const premiumFeatures = t('app:subscribeSimulator.plans.premium.features', { returnObjects: true }) as string[];
        ...
        <div className="grid md:grid-cols-2 gap-6 lg:gap-8 max-w-4xl mx-auto">
          ...
          <Card className="relative flex flex-col transition-all duration-300 hover:shadow-xl border-border hover:border-amber-600/50">
            <CardHeader className="text-center pb-2">
              ...
              <CardTitle className="font-display text-2xl">{t('app:subscribeSimulator.plans.simulator.title')}</CardTitle>
              <CardDescription className="text-base">
                {t('app:subscribeSimulator.plans.simulator.description')}
              </CardDescription>
            </CardHeader>
            ...
            <CardContent className="flex-1 flex flex-col">
              <div className="text-center mb-6">
                <div className="flex items-baseline justify-center gap-1">
                  ...
                  <span className="text-muted-foreground">{t('common:ttc')}/{SIMULATOR_PLANS.simulator.billing}</span>
                </div>
                <p className="text-sm text-muted-foreground mt-2">{t('app:subscribeSimulator.plans.simulator.noCommitment')}</p>
              </div>
              ...
              >
                {t('app:subscribeSimulator.plans.simulator.cta')}
              </Button>
            </CardContent>
          </Card>
          ...
          <Card className="relative flex flex-col transition-all duration-300 hover:shadow-xl border-primary shadow-lg ring-2 ring-primary/20">
            <div className="absolute -top-3 left-1/2 -translate-x-1/2">
              <Badge className="bg-primary text-primary-foreground shadow-md gap-1">
                ...
                {t('app:subscribeSimulator.plans.premium.badge')}
              </Badge>
            </div>
            ...
            <CardHeader className="text-center pb-2">
              ...
              <CardTitle className="font-display text-2xl">{t('app:subscribeSimulator.plans.premium.title')}</CardTitle>
              <CardDescription className="text-base">
                {t('app:subscribeSimulator.plans.premium.description')}
              </CardDescription>
            </CardHeader>
            ...
            <CardContent className="flex-1 flex flex-col">
              <div className="text-center mb-6">
                <div className="flex items-baseline justify-center gap-1">
                  ...
                  <span className="text-muted-foreground">{t('common:ttc')}</span>
                </div>
                <p className="text-sm text-muted-foreground mt-2">{t('app:subscribeSimulator.plans.premium.oneTimePayment')}</p>
              </div>
              ...
              >
                ...
                {t('app:subscribeSimulator.plans.premium.cta')}
              </Button>
            </CardContent>
          </Card>
        </div>
