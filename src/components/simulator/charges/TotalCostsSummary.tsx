    ...
    <Card className="border-lavcom-orange/40 bg-lavcom-orange/10">
      <CardContent className="flex items-center justify-between h-full py-6 px-12">
        <div className="flex flex-col">
          <span className="text-xs uppercase tracking-wider text-muted-foreground">{t("charges.summary.fixed")}</span>
        ...
        <div className="flex flex-col">
          <span className="text-xs uppercase tracking-wider text-muted-foreground">{t("charges.summary.variable")}</span>
          <span className="mt-1 text-xl text-foreground">
        ...
        <span className="text-muted-foreground">=</span>
        <div className="flex flex-col">
          <span className="text-xs uppercase tracking-wider text-foreground">{t("charges.summary.total")}</span>
